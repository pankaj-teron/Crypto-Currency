...
const Trending = () => {
  ...
  return (
    <>
    <section
    className='lg:w-[80%] w-[90%] h-full flex flex-col  mb-24 mt-16 relative ' key={data.coin_id}>
      <div className="w-full flex lg:flex-row flex-col items-center flex-wrap justify-evenly py-8 border
